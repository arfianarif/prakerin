<div class="card shadow mb-4 border-left-primary">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="js-datatable-tu" width="100%" cellspacing="0">
                <thead>
                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        modalHandlerEdit = async (data) => {
            ...
            mBody += `
				<div class="row">
					<input hidden type="text" class="form-control" name="id_tu" value="${data.id_tu}">
					<div class="col-md-6">
						<div class="form-group">
							<label class="">NIK</label>
